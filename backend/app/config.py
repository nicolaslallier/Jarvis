...
class Settings(BaseSettings):
    ...
    # stack. Apps on infra-net reach the API at http://minio:9000. There's
    # no per-app MinIO provisioning yet (unlike Postgres's per-app DB/role),
    # so minio_access_key/minio_secret_key must match MINIO_ROOT_USER /
    # MINIO_ROOT_PASSWORD in the Infra repo's .env for now.
